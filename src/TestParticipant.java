...
public class TestParticipant implements org.apache.thrift.TBase<TestParticipant, TestParticipant._Fields>, java.io.Serializable, Cloneable, Comparable<TestParticipant> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TestParticipant");
  ...
  static {
    schemes.put(StandardScheme.class, new TestParticipantStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TestParticipantTupleSchemeFactory());
  }
  ...
  private static final int __LOCALPORT_ISSET_ID = 1;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TestParticipant.class, metaDataMap);
  }
   ...
   */
  public TestParticipant(TestParticipant other) {
  ...
  public TestParticipant deepCopy() {
  ...
  public TestParticipant setReplicaname(String replicaname) {
    this.replicaname = replicaname;
    return this;
  }
  ...
  public TestParticipant setReplicaIp(String replicaIp) {
    this.replicaIp = replicaIp;
    return this;
  }
  ...
  public TestParticipant setReplicaPort(int replicaPort) {
    this.replicaPort = replicaPort;
    setReplicaPortIsSet(true);
    return this;
  }
  ...
  public TestParticipant setLocalPort(int localPort) {
    this.localPort = localPort;
    setLocalPortIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TestParticipant)
      return this.equals((TestParticipant)that);
    return false;
  }

  public boolean equals(TestParticipant that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TestParticipant other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TestParticipant(");
    boolean first = true;
  ...
  private static class TestParticipantStandardSchemeFactory implements SchemeFactory {
    public TestParticipantStandardScheme getScheme() {
      return new TestParticipantStandardScheme();
    }
  }

  private static class TestParticipantStandardScheme extends StandardScheme<TestParticipant> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TestParticipant struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TestParticipant struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TestParticipantTupleSchemeFactory implements SchemeFactory {
    public TestParticipantTupleScheme getScheme() {
      return new TestParticipantTupleScheme();
    }
  }

  private static class TestParticipantTupleScheme extends TupleScheme<TestParticipant> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TestParticipant struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TestParticipant struct) throws org.apache.thrift.TException {
